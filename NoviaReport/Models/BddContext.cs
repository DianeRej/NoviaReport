    ...
    public class BddContext : DbContext
    {
        ...
        public void InitializeDb()
        {
            ...
            this.CRAs.AddRange(
                ...
                new CRA { Id = 45, Date = new DateTime(2023, 12, 01), State = State.INCOMPLET },
            ...
            this.Activities.AddRange(
                ...
                new Activity { Id = 20, Date = new DateTime(2023, 02, 03), Halfday = true, TypeActivity = TypeActivity.PRESTATION, Client = Client.Client6 },
                new Activity { Id = 21, Date = new DateTime(2023, 02, 03), Halfday = true, TypeActivity = TypeActivity.FORMATION_PROFESSIONNELLE },
                ...
                new Activity { Id = 29, Date = new DateTime(2023, 02, 03), Halfday = true, TypeActivity = TypeActivity.FORMATION_PROFESSIONNELLE },
                ...
                new Activity { Id = 41, Date = new DateTime(2023, 02, 03), Halfday = true, TypeActivity = TypeActivity.PRESTATION, Client = Client.Client6 },
                new Activity { Id = 42, Date = new DateTime(2023, 02, 03), Halfday = true, TypeActivity = TypeActivity.FORMATION_PROFESSIONNELLE },
